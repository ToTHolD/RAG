...
class OllamaRAG:
    ...
    def __init__(
        ...
        self.db1 = RAGDatabase("Медицина", embedding_model_name=embedding_model)
        self.db2 = RAGDatabase("История", embedding_model_name=embedding_model)
    ...
    def _initialize_databases(self):
        ...
        medical_docs = [
            "Диабет 2 типа - это хроническое заболевание, при котором организм не может эффективно использовать инсулин. "
            "Симптомы включают повышенную жажду, частое мочеиспускание, усталость и размытое зрение. "
            "Лечение включает диету, физические упражнения и лекарства для контроля сахара в крови. "
            "Важно регулярно измерять уровень глюкозы и посещать эндокринолога.",

            "Гипертония - это состояние повышенного давления крови в артериях. "
            "Нормальное давление 120/80 мм рт.ст. Факторы риска: ожирение, стресс, курение, наследственность, малоподвижный образ жизни. "
            "Осложнения: инсульт, инфаркт, почечная недостаточность, поражение сетчатки глаза. "
            "Лечение: изменение образа жизни, снижение соли в рационе, медикаменты по назначению врача.",

            "Вакцинация - это введение антигенного материала для стимуляции иммунной системы к выработке антител. "
            "Прививки защищают от инфекционных заболеваний: кори, краснухи, полиомиелита, столбняка, гепатита В. "
            "Вакцинация создает иммунитет без перенесения заболевания. "
            "Календарь прививок утверждается Министерством здравоохранения и включает вакцинацию с рождения.",

            "Первая помощь при ожогах: охладить место ожога прохладной (не ледяной) водой 10-15 минут. "
            "Не вскрывать волдыри — это повышает риск инфекции. Накрыть стерильной неплотной повязкой. "
            "При ожогах 3 степени (белая или обугленная кожа) немедленно вызвать скорую помощь. "
            "Не применять масло, сметану или жирные кремы — они задерживают тепло."
        ]

        history_docs = [
            "Великая французская революция началась в 1789 году с штурма Бастилии 14 июля. "
            "Это привело к свержению монархии Людовика XVI и установлению республики. "
            "Основные идеи революции: свобода, равенство, братство. "
            "Революция закончилась приходом к власти Наполеона Бонапарта в 1799 году. "
            "Период террора 1793-1794 годов унёс жизни тысяч людей.",

            "Вторая мировая война продолжалась с 1939 по 1945 год. "
            "Основные участники: страны Оси (Германия, Италия, Япония) против союзников (СССР, США, Великобритания, Франция). "
            "Война началась с нападения Германии на Польшу 1 сентября 1939 года. "
            "Закончилась капитуляцией Германии 8 мая 1945 и Японии 2 сентября 1945. "
            "Погибло более 60 миллионов человек, война изменила политическую карту мира.",

            "Открытие Америки Христофором Колумбом произошло 12 октября 1492 года. "
            "Колумб достиг Багамских островов, приняв их за Индию, поэтому коренных жителей назвал индейцами. "
            "Это событие положило начало европейской колонизации Американского континента. "
            "Колумб совершил 4 экспедиции к берегам Америки между 1492 и 1504 годами.",

            "Древний Рим был основан согласно легенде в 753 году до н.э. братьями Ромулом и Ремом. "
            "Римская империя достигла максимального расширения во II веке н.э. при императоре Траяне. "
            "Западная Римская империя пала в 476 году н.э. под натиском варварских племен. "
            "Рим оставил наследие в праве, архитектуре, языке и системе управления."
        ]

        # Добавляем документы с оптимальными параметрами чанкинга
        self.db1.add_documents(medical_docs, chunk_size=500, chunk_overlap=100)
        self.db2.add_documents(history_docs, chunk_size=500, chunk_overlap=100)
...
if __name__ == "__main__":
    ...
    test_queries = [
        "Какие симптомы диабета и как его лечить?",
        "Когда началась Вторая мировая война?",
        "Что такое вакцинация и зачем нужны прививки?",
        "Кто открыл Америку и в каком году?",
